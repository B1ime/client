      ...
      <div className="all">
        ...
        <form>
          <div className="form-group">
            <label htmlFor="exampleInputEmail1">방 이름</label>
            <input type="name" className="form-control" placeholder="방 이름" />
          </div>
          <hr />
          <div className="form-group" id="num">
            <label htmlFor="inputState">참여인원</label>
          ...
          <div className="form-group" id="time">
            <label htmlFor="inputPassword4">약속시간</label>
            <input
              type="password"
